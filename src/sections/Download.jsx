          ...
          <div className="container">
               <div className="flex items-center">
                    <div className="relative mr-6 flex-540 max-xl:flex-280 max-lg:flex-256 max-md:flex-100">
                         ...
                         <p className='body-1 mb-10 max-w-md'>Try it now for free on iOS, Android, PC, Web - whatever you flavor, we've got you covered.</p>
                              ...
                              {links.map(({ id, url, icon }) => (
                                   <li key={id} className='download_tech-link download_tech-link_last-before download_tech-link_last-after'>
                                        <a href={url} className='size-22 download_tech-icon-before relative flex items-center justify-center rounded-half border-2 border-s3 bg-s1 transition-borderColor duration-500'>
                                             ...
                                             <span className="download_teck-icon">{icon}</span>
                                        </a>
                                   </li>
                              ))}
                         </ul>
                    ...
                    <div className="mb-10 max-md:hidden">
                         <div className="download_preview-before download_preview-after rounded-40 relative w-[955px] border-2 border-s5 p-6">
                              <div className="relative rounded-3xl bg-s1 px-6 pb-6 pt-14">
                                   <span className='download_preview-dot left-5 bg-p2' />
